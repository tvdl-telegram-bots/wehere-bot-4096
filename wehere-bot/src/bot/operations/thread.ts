...
import type { ChatId, ThreadPlatform } from "wehere-bot/src/typing/common";
...
export function generateThreadEmoji(platform: ThreadPlatform) {
...
export async function createThread(
  ...
  const thread: WithoutId<PersistentThread> = {
    ...
    emoji: generateThreadEmoji(params.platform),
    createdAt: Date.now(),
